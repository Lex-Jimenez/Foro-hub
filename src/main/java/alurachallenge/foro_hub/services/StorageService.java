...
import alurachallenge.foro_hub.services.iServices.iStorageService;
...
public class StorageService implements iStorageService {
    ...
    public Resource cargarRecurso(String nombreArchivo) {
        try {
            ...
            throw new BadRequestException("ERROR: No se puede leer el archivo! "+nombreArchivo, e);
        }
    }
    ...
    public void eliminarRecurso(String nombreArchivo) {
        ...
        try {
            ...
            throw new BadRequestException("ERROR: No se puede eliminar el archivo! " + nombreArchivo);
        }
    }
}
